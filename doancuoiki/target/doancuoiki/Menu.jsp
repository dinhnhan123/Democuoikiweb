...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background-color: #E9B749">
    <div class="container" >
        <a class="navbar-brand" href="homeControl">Nhà Hàng Nhân Đinh</a>
...
<section class="jumbotron text-center" >
    <div class="container">
        <h1 class="jumbotron-heading">Nhà Hàng với nhiều món ăn ngon rẻ</h1>
        <p class="lead text-muted mb-0" style="color:white ">Uy tín tạo nên thương hiệu với hơn 10 năm làm đầu bếp của chef Nhân Đinh
            </p>
    </div>
</section>
<!--end of menu-->
